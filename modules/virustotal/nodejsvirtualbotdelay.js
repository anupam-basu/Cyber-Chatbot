...
var replyavlist =
  "Virus Alert: This file is a virus according to the following Antivirus:\n";
var replydontknow =
  "Sorry I do not understand this question, please try again.";
...
function botdelay() {
  ...
  api.intercept((event) => {
    ...
    con.setKey(
      "e8c926d71eea9f24896f741f679295593bda6232881c5d64015dee50f801b063",
    );
    var s = "";
    //var detailreport="";
    let ans = "not";
...
function replytoquestion(str, data, qtype) {
  ...
  if (qtype == qavsay) return replyavlist + str;
...
function getFileListFromS3() {
  ...
  if (fileliststr == "" || tempUser != userID) fileliststr = "NULL";
  filelist.length = 0;
}
